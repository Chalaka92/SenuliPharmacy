...
import { ChartWidgetOptions } from "../../../@sp/shared/chart-widget/chart-widget-options.interface";
...
export class DashboardComponent implements OnInit {
  ...
  private _realtimeUsersDataSubject = new ReplaySubject<RealtimeUsersWidgetData>(
    30
  );
  ...
  ngOnInit() {
    ...
    this.itemBatchCount = this.dashboardService.itemBatchCount;

    this.spService._itemBatchService
      .getAllItemBatches()
      .subscribe((response) => {
        this.itemBatchCount = response.length;
      });
